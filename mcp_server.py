...
def format_document(
    ...
    prompt = f"""
    Your goal is to reformat a document to be written with markdown syntax.base
    ...
    Add in headers, bullet points, tables, ect as necessary. Feel free to add in ex
